...
import inquirer, { Answers, RadioQuestionOptions } from '../../index.js';
import Paginator from '../utils/paginator.js';
import Prompt from './base.js';

/**
 * The question-options for the {@link RadioPrompt `RadioPrompt<TQuestion>`}.
 */
type Question = RadioQuestionOptions;
...
declare class RadioPrompt<TQuestion extends Question = Question> extends Prompt<TQuestion> {
    ...
    /**
     * Initializes a new instance of the {@link RadioPrompt `RadioPrompt<TQuestion>`} class.
     *
     * @param question
